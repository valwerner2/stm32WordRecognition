...
#define POTI_ADC_Pin GPIO_PIN_6
#define POTI_ADC_GPIO_Port GPIOF
...
#define BUTTON_CENTER_GPIO_Port GPIOD
...
#define BUTTON_T3_Pin GPIO_PIN_14
#define BUTTON_T3_GPIO_Port GPIOG
#define SDNCAS_Pin GPIO_PIN_15
#define SDNCAS_GPIO_Port GPIOG
#define BUTTON_T2_Pin GPIO_PIN_3
#define BUTTON_T2_GPIO_Port GPIOB
#define SDCKE1_Pin GPIO_PIN_5
#define SDCKE1_GPIO_Port GPIOB
#define SDNE1_Pin GPIO_PIN_6
#define SDNE1_GPIO_Port GPIOB
#define BUTTON_T1_Pin GPIO_PIN_7
#define BUTTON_T1_GPIO_Port GPIOB
